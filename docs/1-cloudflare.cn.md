...
| --- | --- | --- | --- | --- |
| HTTP 请求 / zone / 天 | 100,000 | 10M / 月 | 100M / 月 | 自定义 |
| Workers 请求 / 天 | 100,000 | 1M / 月 | 20M / 月 | 自定义 |
| Pages 请求 | 不限（带宽上限） | 不限（带宽上限） | 不限（带宽上限） | 自定义 |
| KV 读 / 天 | 100,000 | 10M | 100M | 自定义 |
| KV 写 / 天 | 1,000 | 1M | 10M | 自定义 |
| KV 删 / 天 | 1,000 | 1M | 10M | 自定义 |
| R2 操作 / 月 | 10M（A 级） | 50M | 自定义 | 自定义 |
| D1 读 / 天 | 5M | 5B（行数） | 自定义 | 自定义 |
